...
## Project Structure
    ...
    module1_ml_pipeline/
    ├── data/raw/          # 100 synthetic documents (20 per class)
    ├── data/splits/       # train/val/test CSVs
    ├── features/          # TF-IDF matrices and vectorizer
...
- Text cleaning: lowercasing, punctuation removal, stopword removal, Porter stemming
- TF-IDF vectorizer: 5000 features, bigrams, sublinear TF
- Fitted on train split only to prevent data leakage
- 3 handcrafted features: word count, average word length, digit ratio
...
- Train vs val vs test accuracy comparison
...
Outputs predicted class and confidence scores for all 5 classes.
